            ...
            if ( _setQty > _unitQty ){
                ...
                success:function(results){
                        ...
                        if(results.noaddedPrice > 0){
                            ...
                            var _Gamount = _setQty * parseFloat( _setSRP );
